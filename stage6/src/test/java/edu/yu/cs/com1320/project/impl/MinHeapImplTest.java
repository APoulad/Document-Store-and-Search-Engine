...
public class MinHeapImplTest {
    ...
    void withDocs(){
        ...
        try {
            Document doc1 = new DocumentImpl(new URI("1st"), "Words for Doc one", null);
            Document doc2 = new DocumentImpl(new URI("2nd"), "Words for Doc two", null);
            Document doc3 = new DocumentImpl(new URI("3rd"), "Words for Doc three", null);
            Document doc4 = new DocumentImpl(new URI("4th"), "Words for Doc four", null);
